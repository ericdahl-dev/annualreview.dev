 ...
 * Optional: LLM_MODEL, PREMIUM_LLM_MODEL (defaults: Claude 3 Haiku free, Claude 3.5 Sonnet premium). MAX_USER_TOKENS_FREE, MAX_USER_TOKENS_PREMIUM (context caps per tier; defaults 500k free, 184k premium).
